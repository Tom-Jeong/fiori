		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#syncdcppplantopo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncdcppplantopo-display": {
								"semanticObject": "syncdcppplantopo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.dc.pp.plantopo",
									"url": sap.ui.require.toUrl("sync/dc/pp/plantopo")
								}
							}
						}
					}
