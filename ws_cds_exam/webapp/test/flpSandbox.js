		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "특강 cds 활용 예제",
									"targetURL": "#syncd20wscdsexam-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncd20wscdsexam-display": {
								"semanticObject": "syncd20wscdsexam",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.d20.wscdsexam",
									"url": sap.ui.require.toUrl("sync/d20/wscdsexam")
								}
							}
						}
					}
