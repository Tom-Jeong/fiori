		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "생산단가 조회",
									"targetURL": "#syncdcppproduction-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncdcppproduction-display": {
								"semanticObject": "syncdcppproduction",
								"action": "display",
								"description": "생산단가 조회",
								"title": "생산단가 조회",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.dc.pp.production",
									"url": sap.ui.require.toUrl("sync/dc/pp/production")
								}
							}
						}
					}
