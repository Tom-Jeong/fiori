		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[D20] 회원정보 조회 및 등록",
									"targetURL": "#cl4exprogramd20-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl4exprogramd20-display": {
								"semanticObject": "cl4exprogramd20",
								"action": "display",
								"description": "회원정보조회",
								"title": "[D20] 회원정보 조회 및 등록",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl4.exprogramd20",
									"url": sap.ui.require.toUrl("cl4/exprogramd20")
								}
							}
						}
					}
